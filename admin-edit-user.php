...
if (isset($_POST['edit_modal'])) {
  $_SESSION['userID'] = $_POST['edit_modal'];
  
}
$userID = $_SESSION['userID'];
$getSpecificUser = "SELECT * FROM Users WHERE id = '".$userID."'";
$result = $conn->query($getSpecificUser);
...
if (isset($_POST['update'])) {
  ...
  $sql = "UPDATE Users SET username = '" . $username . "',
    ...
    sss = '" . $sss . "', 
    tin = '" . $tin . "', 
    philhealth = '" . $philh . "' WHERE id='" . $userID . "'";

  if ($conn->query($sql)) {
    echo '<script>
    alert("Updated Successfully");
    window.location = ("admin-edit-user.php");
  </script>';
...
<body>
  <header>
    <a href="admin-home.php" target="_self"><img class="header-icon" src="img/icon-admin32.png"></a>
...
<!-- *****Update USER MODAL***** -->
  ...
  <div id="form-container">
    ...
    <h3>Update UserID: <?php echo $userID; ?></h3>
    <form method="post">
      <div id="input1-cntr">
